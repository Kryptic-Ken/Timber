...
int main()
{
	...
	textureBranch.loadFromFile("graphics/sprite_branch.png");
	...
	texturePlayer.loadFromFile("graphics/sprite_Player.png");
	Sprite spritePlayer;
	...
	Texture textureRIP;
	textureRIP.loadFromFile("graphics/sprite_Grave.png");
	Sprite spriteRIP;
	spriteRIP.setTexture(textureRIP);
	spriteRIP.setPosition(600, 860);
	// Prepare the axe
	Texture textureAxe;
	textureAxe.loadFromFile("graphics/sprite_Axe.png");
	Sprite spriteAxe;
	...
	//Prepare the falling log
	Texture textureLog;
	textureLog.loadFromFile("graphics/sprite_Log.png");
	Sprite spriteLog;
	...
	Sound chop; chop.setBuffer(chopBuffer);
	SoundBuffer deathBuffer;
	deathBuffer.loadFromFile("sounds/death.wav");
	Sound death; death.setBuffer(deathBuffer);
	// Out of time
